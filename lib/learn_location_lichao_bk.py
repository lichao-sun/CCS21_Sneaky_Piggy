...
def learn_location_mlp_softmax(accel_file, gyro_file, params, verbose=True):
    ...
    if params['test_experiment'] == True:
        accel_file = "/home/sunlichao/Documents/lehigh_cloud/CCS21/data/sample_" + params["test_file_id"] + "/accel.txt"
        gyro_file = "/home/sunlichao/Documents/lehigh_cloud/CCS21/data/sample_" + params["test_file_id"] + "/gyro.txt"
...
if __name__ == "__main__":
    ...
    params['digital_only'] = True
    params['test_digital_only'] = False
    params['data_shape'] = 1
    params['output_dim'] = 8
    params['first_data_load'] = True
    params['nb_epoch'] = 500
    params['batch_size'] = 30
    params['test_experiment'] = True
    params['test_file_id'] = "2"
    # params['m'] = 22
    # params['n'] = 10
    # params['m'] = 1
    # params['n'] = 3187
    ...
    # learn_location_mlp_softmax_test("/home/sunlichao/Documents/lehigh_cloud/CCS21/data", "", "", params)
