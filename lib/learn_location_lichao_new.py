...
def learn_location_gru_softmax(accel_file, gyro_file, params, verbose=True):
    ...
    if params['test_experiment'] == True:
        accel_file = "/home/sunlichao/Documents/lehigh_cloud/CCS21/data_test/sample_" + params[
            "test_file_id"] + "/accel.txt"
        gyro_file = "/home/sunlichao/Documents/lehigh_cloud/CCS21/data_test/sample_" + params[
            "test_file_id"] + "/gyro.txt"
...
def learn_location_gru_mse(accel_file, gyro_file, params, verbose=True):
    ...
    if params['digital_only']:
        filepath = "weights.best_" + ori_accel_file.replace("_accel", "").replace(".txt",
                                                                                  "_X") + "_digitonly_gru_mse.hdf5"
    else:
